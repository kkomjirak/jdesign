      ...
      >
        <div className="px-10 pt-4 pb-20 h-[calc(100vh-44px)] overflow-y-auto">
          <ul ref={menuItemsRef} className="flex flex-col">
            ...
            <li className="border-b border-[#1D1D1F]/10 dark:border-[#F5F5F7]/10 last:border-0">
              <a
                href="https://instagram.com"
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-3 py-3 text-2xl font-semibold tracking-tight text-[#1D1D1F] dark:text-[#F5F5F7] opacity-90 hover:opacity-100"
                onClick={() => setIsMobileMenuOpen(false)}
              >
